...
describe "Beerlist page" do
  ...
  it "is defaultly ordered by name", js:true do
    visit beerlist_path
  ...
  it "is ordered by style when style clicked", js:true do
    visit beerlist_path
    click_link 'style'
  ...
  it "is ordered by brewery when brewery clicked", js:true do
    visit beerlist_path
    click_link 'brewery'
